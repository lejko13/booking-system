...
export default function HeroSection() {
  ...
  return (
    <section className="mx-auto grid w-full  lg:max-w-[var(--container)]  items-center gap-12
     px-[var(--section-x)] 
     py-[var(--section-y)] 
    lg:grid-cols-2">
  ...
  className="inline-flex items-center justify-center gap-2 rounded-[var(--radius-full)] bg-[var(--primary)] px-7 py-4 font-semibold text-[var(--text-white)] shadow-lg hover:bg-[var(--primary-hover)]"
>
  Získať rezervačný systém  <ArrowRight size={18} />
</button>
        </div>
